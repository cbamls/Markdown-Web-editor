...
<title>水墨 - 在线Markdown编辑器</title>
<meta name="description" content="水墨编辑器，一款在线markdown编辑器，支持markdown转pdf，markdown转html等"/>
<meta name="keywords" content="markdown,markdown编辑器,水墨编辑器,在线markdown,markdown在线,markdown转pdf" />
<link rel="icon" type="image/png" href="${ctx}/images/logo.jpeg"/>
...
<link href="${ctx}/templete/green.css" rel="stylesheet">
